    ...
    return selectedUser ?
        (
            <div className='h-full flex flex-col h-full overflow-hidden relative backdrop-blur-lg'>
                ...
                <div className='flex items-center gap-3 py-3 max-4 border-b border-stone-500 mx-2'>
                ...
                <div className='flex flex-col h-[calc(100% - 120px)] overflow-y-scroll p-3 pb-6 mb-5'>
                    {
                        messages.map((msg, index) => (
                            <div key={index} className={`flex item-end gap-2 justify-end ${msg.senderId !== selectedUser._id && 'flex-row-reverse'}`}>
                                {
                                    msg?.image ?
                                        <img
                                            src={msg.image}
                                ...
                                <div className='text-center text-xs'>
                                    <img
                                        src={msg.senderId === authUser._id ? selectedUser.profilePic || assets.avatar_icon : authUser.profilePic || assets.avatar_icon}
                                        alt=""
